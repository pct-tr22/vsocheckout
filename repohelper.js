var debug = require('debug')('vsocheckout:repohelper');

var root = __dirname;//so i don't see squigglies on each __dirname

///superagent setup...
var request = require('superagent');
var PullRequest = require( root + '/pullRequest.js');
